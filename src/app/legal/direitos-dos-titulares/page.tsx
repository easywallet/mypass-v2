...
export default function DireitosDosTitulares() {
    ...
    return (
        <LegalPageLayout
            topic="Direitos dos Titulares (LGPD)"
            title="Portal de Privacidade e Direitos"
            lastUpdated="01 de março de 2026"
        >
            <p className="text-slate-400 text-lg mb-12">
                Conforme garantido pelo Art. 18 da LGPD, você possui controle absoluto sobre os dados fornecidos à MyPass. Utilize os formulários abaixo para formalizar a sua solicitação junto ao nosso Data Protection Officer (DPO). O prazo regulatório de resposta ou execução integral é de 15 dias.
            </p>
